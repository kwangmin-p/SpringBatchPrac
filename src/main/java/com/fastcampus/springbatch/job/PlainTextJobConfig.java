...
import com.fastcampus.springbatch.core.repository.PlainTextRepository;
...
public class PlainTextJobConfig {
    ...
    public RepositoryItemReader<PlainText> plainTextReader(){
        return new RepositoryItemReaderBuilder<PlainText>()
                ...
                .methodName("findBy")
                .pageSize(5)
                .arguments(List.of()) // 이 경우에는 Page만 사용해서 필요없는데 조회조건 등 Args 필요한 경우 사용
    ...
    @StepScope
    @Bean
    public ItemProcessor<PlainText, String> plainTextProcessor() { // 프로세싱 전/후 타입
